...
def create_initials(s):
    """
    Создает хэш участника на основе его ФИО.
    :param s: ФИО участника (str)
    :return: хэш участника (str)
    """
    names = s.split()
...
def create_password():
    """
    Создает случайный пароль из букв и цифр.
    :return: случайный пароль (str)
    """
